...
class distLinear(nn.Module):
    def __init__(self, indim, outdim):
        ...
        if outdim <= 200:
            self.scale_factor = 2;  #  orig = 2 a fixed scale factor to scale the output of cos value into a reasonably large input for softmax, for to reproduce the result of CUB with ResNet10, use 4. see the issue#31 in the github
        else:
            self.scale_factor = 10;  # orig = 10 in omniglot, a larger scale factor is required to handle >1000 output classes.
