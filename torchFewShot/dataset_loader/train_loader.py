...
class FewShotDataset_train(Dataset):
    ...
    def _sample_episode(self):
        ...
        """
        #print(self.labelIds, self.nKnovel)
    ...
    def _creatExamplesTensorData(self, examples):
        ...
        # print(images.size())
        return images, labels, cls, labels_name


    def __getitem__(self, index):
        Tnovel, Exemplars = self._sample_episode()
        #Xt, Yt, Ytc, _ = self._creatExamplesTensorData(Exemplars)
        Xt, Yt, Ytc, train_name = self._creatExamplesTensorData(Exemplars) 
        Xe, Ye, Yec, _ = self._creatExamplesTensorData(Tnovel)
        #return Xt, Yt, Xe, Ye, Yec, Ytc, train_name  
