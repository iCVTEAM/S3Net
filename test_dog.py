...
# Datasets
parser.add_argument('-d', '--dataset', type=str, default='dogs')
...
parser.add_argument('--save-dir', type=str, default='./result/dogs/CAM/5-shot-seed1-conv4_nonlocal_globalcos_few_loss/')
parser.add_argument('--resume', type=str, default='./result/dogs/CAM/5-shot-seed1-conv4_nonlocal_globalcos_few_loss/best_model.pth.tar', metavar='PATH')
# FewShot settting
