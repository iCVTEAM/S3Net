...
from args_cars import argument_parser
import os
import sys
import time
import datetime
...
def train(epoch, model, criterion,optimizer, trainloader, learning_rate, use_gpu):
    ...
    for batch_idx, (images_train, labels_train, images_test, labels_test, pids, pids_train) in enumerate(trainloader):
        ...
        ytest, ytest_avg, score = model(images_train, images_test, labels_train_1hot, labels_test_1hot)    
    ...
    print('Epoch{0} '
	  ...
	  'Loss_f:{loss_few.avg:.4f}' .format(
              ...
              data_time=data_time, loss=losses, loss_softmax=softmax_loss, loss_few = few_losses))
