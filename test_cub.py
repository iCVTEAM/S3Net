...
parser.add_argument('--save-dir', type=str, default='./result/cub/CAM/5-shot-seed1-conv4_nonlocal_globalcos_few_loss/')
parser.add_argument('--resume', type=str, default='./result/cub/CAM/5-shot-seed1-conv4_nonlocal_globalcos_few_loss/best_model.pth.tar', metavar='PATH')
# FewShot settting
